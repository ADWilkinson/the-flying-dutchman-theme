...
exports.AccessibilityValidator = void 0;
class AccessibilityValidator {
    ...
    meetsWCAGAA(ratio, largeText = false) {
        return largeText ? ratio >= 3 : ratio >= 4.5;
    }
    meetsWCAGAAA(ratio, largeText = false) {
        return largeText ? ratio >= 4.5 : ratio >= 7;
    }
    extractMainColors(theme) {
    ...
    checkColorblindAccessibility(colors) {
        const issues = [];
    ...
    generateAccessibilityReport(theme) {
        const report = {
