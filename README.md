...
[![Visual Studio Marketplace Installs](https://img.shields.io/visual-studio-marketplace/i/DavyJones.the-flying-dutchman-theme?color=%235dade2&label=Installs&logo=visual-studio-code)](https://marketplace.visualstudio.com/items?itemName=DavyJones.the-flying-dutchman-theme)
[![Visual Studio Marketplace Rating](https://img.shields.io/visual-studio-marketplace/r/DavyJones.the-flying-dutchman-theme?color=%2348bb78&label=Rating&logo=visual-studio-code)](https://marketplace.visualstudio.com/items?itemName=DavyJones.the-flying-dutchman-theme)
...
1. **[Click here to install directly](vscode:extension/DavyJones.the-flying-dutchman-theme)** ← One-click install!
2. Reload VS Code when prompted  
3. `Ctrl+Shift+P` → "Preferences: Color Theme" → "The Flying Dutchman"
...
### iTerm2 (macOS)
1. Download [`The-Flying-Dutchman.itermcolors`](./iterm/The-Flying-Dutchman.itermcolors)
2. Double-click the file to import, or:
...
3. Add to the `"schemes"` array in settings.json
4. Apply in Profiles → Appearance → Color scheme
...
https://raw.githubusercontent.com/ADWilkinson/the-flying-dutchman-theme/main/vim/colors/flying-dutchman.vim
```
Add to your `.vimrc` or `init.vim`: `colorscheme flying-dutchman`

### Sublime Text
1. Download [`The-Flying-Dutchman.tmTheme`](./sublime-text/The-Flying-Dutchman.tmTheme)
2. Sublime Text → Preferences → Browse Packages
3. Copy theme file to `User/` folder  
4. Preferences → Color Scheme → User → "The Flying Dutchman"
...
3. Follow our [color palette standards](#color-palette)
4. Submit a PR with installation instructions
...
<details>
<summary><strong>Can I customize specific colors?</strong></summary>
...
<details>
<summary><strong>Is there a light version planned?</strong></summary>

We're considering "The Flying Dutchman: Dawn" - a light variant inspired by sunrise over the ocean. [Vote for it here](https://github.com/ADWilkinson/the-flying-dutchman-theme/discussions) or contribute ideas!

</details>

<details>
<summary><strong>How often is the theme updated?</strong></summary>
...
<details>
<summary><strong>Does this theme work with all VS Code extensions?</strong></summary>

The theme is designed to work seamlessly with popular extensions. If you notice compatibility issues with specific extensions, please [report them](https://github.com/ADWilkinson/the-flying-dutchman-theme/issues) and we'll address them in the next update.
...
[![Code Quality](https://img.shields.io/badge/Code%20Quality-A+-blue)](https://github.com/ADWilkinson/the-flying-dutchman-theme)
